//This shader assigns the mesh's color based on a single color. Good for testing and primitives.

shader_type spatial;

uniform vec4 color:hint_color; //The base color applied to the entire mesh
uniform sampler2D palette_tex:hint_albedo; //The color palette texture. Every color should be a single pixel.
uniform float tex_size = 16.0; //The number of colors in the texture.
